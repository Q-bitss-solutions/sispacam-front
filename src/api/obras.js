...
export function cambioEstatus(dataIdClaveCamino, data) {
  return request({
    url: '/caminos/' + dataIdClaveCamino + '/estatus/',
    method: 'post',
    data,
    headers: { "Content-Type": "multipart/form-data" }
  })
...
export function getHistorialEstatus(clave_camino) {
  return request({
    url: '/caminos/' + clave_camino + '/estatus/',
    method: 'get'
  })
}