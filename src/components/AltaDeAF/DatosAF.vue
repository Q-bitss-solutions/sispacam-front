                    ...
                    <div class="form-group" >
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <input class="form-control" v-model="FrmRodamiento.rodera1_izquierda" id="roderaizq" placeholder=" " type="number" :disabled = "editmode">
                            </div>
                            <div class="col-sm-4">
                                <label class="control-label" for="empedradoizq">Empedrado  (m)​</label>
                                <input class="form-control" v-model="FrmRodamiento.empedrado_izquierda"  id="empedradoizq" placeholder=" " type="number" >
                            </div>
                            <div class="col-sm-4">
                                <label class="control-label" for="roderader">Rodera 2 (m)​</label>
                                <input class="form-control" v-model="FrmRodamiento.rodera2_izquierda" id="roderaeder" placeholder=" " type="number" >
                            </div>
                        </div>
                    </div>
                </td>
                <td>
                    <div class="form-group" >
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <label class="control-label" for="Empedradocen">Empedrado central</label>
                                <input class="form-control" v-model="FrmRodamiento.empedrado_central" id="Empedradocen" placeholder=" " type="number" :disabled = "editmodecen">
                            </div>
                   ...
                   <div class="form-group" >
                        <div class="row"> 
                            <div class="col-sm-4">
                                ...
                                <input class="form-control" v-model="FrmRodamiento.rodera1_derecha"  id="rodera1der" placeholder=" " type="number" >
                            </div>
                            <div class="col-sm-4">
                                <label class="control-label" for="empedradoder">Empedrado  (m)​</label>
                                <input class="form-control"  v-model="FrmRodamiento.empedrado_derecha" id="empedradoder" placeholder=" " type="number" >
                            </div>
                            <div class="col-sm-4">
                                <label class="control-label" for="rodera2der">Rodera 2 (m)​</label>
                                <input class="form-control" v-model="FrmRodamiento.rodera2_derecha" id="rodera2der" placeholder=" " type="number" :disabled = "editmode">
                            </div>
                        </div>
                    </div>
                </td>
            ...
            <tr>
                <td align="center">
                    <div class="col-sm-4 ">
                        ...
                        <input class="form-control" v-model="kmpsp" id="kmpsp" placeholder=" " type="number" disabled>
                    </div>
                    <div class="col-sm-4 " >
                        <label class="control-label" for="porcenpsp">%</label>
                        <input class="form-control" v-model="porcenpsp" id="porcenpsp" placeholder=" " type="number" disabled>
                    </div>
                </td>
                <td align="center">
                    <div class="col-sm-4">
                        <label class="control-label" for="kmps">Km​​</label>
                        <input class="form-control" v-model="kmps" id="kmps" placeholder=" " type="number" disabled>
                    </div>
                    <div class="col-sm-4">
                        <label class="control-label" for="porcenps">%</label>
                        <input class="form-control" v-model="porcenps" id="porcenps" placeholder=" " type="number" disabled>
                    </div>
                ...
                <td align="center">
                    <div class="col-sm-4 " >
                        ...
                        <input class="form-control" v-model="kmpspa"  id="kmps" placeholder=" " type="number" disabled>
                    </div>
                    <div class="col-sm-4 ">
                        <label class="control-label" for="porcenpa">%</label>
                        <input class="form-control" v-model="porcenpa" id="porcenpa" placeholder=" " type="number" disabled>
                    </div>
