...
<div>
  ...
  <div class="row">
    <div class="col-md-12 text-left to-left">
        ...
        type="button"
        id="bt-nvo-convenio"
        v-on:click="openModalAddConvenio" 
      ...
      <e-aggregates>
        <e-aggregate :showChildSummary='false'>
          <e-columns>
            ...
            <e-column type="Custom" columnName="monto" :customAggregate="customAggregateMontoFn" :footerTemplate='footerMonto'></e-column>
            <e-column type="Custom" :customAggregate="customAggregateMetaFn" field="meta" :footerTemplate='footerMeta'></e-column>
          </e-columns>
        </e-aggregate>
      </e-aggregates>           
    </ejs-treegrid>
    ...
    <form>
      ...
      <div class="form-row">
        <div class="form-group col-md-6"> 
            ...
            <select 
              :disabled="isDisabledMod"
              v-model="formMoficatorio.origen" id="tramo"
              class="form-control modificatorio"
            >
              <option value=''>Seleccionar...</option>
              <option value='PEF'>PEF</option>
        ...
        <div class="form-group col-md-6">
          ...
          <input 
            ...
            id="fileconvenio" 
            type="file" accept=".pdf" 
            @change="onFileSelectedModificatorio" 
            name="myfile"
          >
        </div>               
      </div>
    ...
    data(){
      return {
        ...
        footerMonto: function () {
          return  { template : Vue.component('footerMonto', {
