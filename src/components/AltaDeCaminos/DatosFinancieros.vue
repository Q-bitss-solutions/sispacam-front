        ...
        <div class="row">
            ...
            <div class="col-md-4 col-md-offset-3">
                ...
                <div v-if="tbusqueda === 'pasado'">
                    ...
                    <!-- Crea una consulta con el último día de cada año  -->
        ...
        <div id="app">
                ...
                <div class="col-md-12">
                    ...
                    <ejs-grid ref='grid1' id='FirstGrid' height='450px' width="100%" :dataSource='clave'
                        ...
                        <e-columns>
                            ...
                            <e-column field='modificado' headerText='Modificado' textAlign='right'
                                format='C2'></e-column>
                            <e-column field='ejercido' headerText='Ejercido' textAlign='right' format='C2'></e-column>
                            <e-column field='comprometido' headerText='Comprometido' textAlign='right'
                                format='C2'></e-column>
                            <e-column field='pagado' headerText='Pagado' textAlign='right' format='C2'></e-column>
                            <e-column field='disponible' headerText='Disponible' textAlign='right'
                                format='C2'></e-column>
                        </e-columns>
                    </ejs-grid>
                </div>
            ...
            <ejs-grid ref='grid2' id='SecondGrid' :dataSource='lista' width="100%" :allowPdfExport='true'
                ...
                <e-columns>
                    ...
                    <e-column field='reintegro' headerText='Reintegro' textAlign='right' format='C2'
                        width=150></e-column>
