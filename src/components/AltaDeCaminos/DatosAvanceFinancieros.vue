        ...
        <ejs-grid   ref="grid"
            ...
            <e-columns>
                ...
                <e-column field='poblacion_indigena' headerText='Tipo Poblacion' ></e-column>
                 <e-column field="clave" :template='editTemplate' headerText='Avance Físico' textAlign='Center' ></e-column>
...
import ButtonGridAF from '@/components/ButtonGridAF'
    ...
    methods: {
        ...
        async populate () {
            try{
                ...
                let data = null
                if(this.flag){
                    results = await getObrasByUsuario(47971)   
